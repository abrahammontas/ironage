...
<!-- Intro Section -->
    <section class="inner-intro dark-bg bg-image overlay-dark parallax parallax-background1" data-background-img="../img/IAO/products-bg.jpg">
        <div class="container">
            <div class="row title">
                <h2 class="h2">The Glenn Table</h2>
            </div>
        </div>
    </section>
    <!-- End Intro Section -->
    ...
    <section class="pt pt-sm-80">
        <div class="container">
            <div class="row mb-60 mb-xs-30">
                <div class="col-md-6">
                    <h4>The Glenn Conference/ Communal Table</h4>
                </div>
                <div class="col-md-6">
                    <p class="lead">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel image-slider o-flow-hidden">
                        <div class="item">
                            <img src="../img/products/glenn-12x8.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/glenn-12x8-2.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mtb-60 mtb-xs-30">
                <div class="col-md-4 mb-30">
                    <div class="project-detail-block">
                        <p>
                            <strong class="dark-color">Product :</strong>Glenn Table
                        </p>
                        <p>
                            <strong class="dark-color">Drawers :</strong>No
                        </p>
                        <p>
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-30">
                            <h5>Popular Conference Table Dimensions</h5>
                            <p>120"L x 48"W x 30"H</p>
                            <h5>Popular Worktop Table Dimensions</h5>
                            <p>120"L x 48"W x 37"H</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-30">
