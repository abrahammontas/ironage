...
@section('title', 'Saxon Storage - Open')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel image-slider o-flow-hidden">
                        <div class="item">
                            <img src="../img/products/saxon-storage-open-1.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/saxon-storage-open-2.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mtb-60 mtb-xs-30">
                <div class="col-md-4 mb-30">
                    <div class="project-detail-block">
                        <p>
                            <strong class="dark-color">Product :</strong>Saxon Storage - Open
                        </p>
                        <p>
        ...
        <div class="container text-center">
            ...
            <div class="row">
                ...
                (
                    ...
                    array('saxon-storage-doors', 'saxon-storage-doors-1.jpg', 'Saxon Storage w/ Doors')
                );
