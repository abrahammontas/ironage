...
@section('title', 'Saxon Storage - Doors')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel image-slider o-flow-hidden">
                        <div class="item">
                            <img src="../img/products/saxon-storage-doors-1.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/saxon-storage-doors-2.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/saxon-storage-doors-3.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mtb-60 mtb-xs-30">
                <div class="col-md-4 mb-30">
                    <div class="project-detail-block">
                        <p>
                            <strong class="dark-color">Product :</strong>Saxon Storage w/ Doors
                        </p>
                        <p>
                            <strong class="dark-color">Shelves :</strong>Two
                        </p>
                        <p>
                            <strong class="dark-color">Wire Port :</strong>N/A
                        </p>
                    </div>
                </div>
                <div class="col-md-8">
                    <div class="row">
                        <div class="col-md-6 mb-30">
                            <h5>Price</h5>
                            <p>Starting at $1400</p>
                            <p>Purchase 3 or more at a discounted rate.</p>
                        ...
                        <div class="col-md-6 mb-30">
                            ...
                            <p>34" wide x 28.5" tall x 21" deep</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-30">
        ...
        <div class="container text-center">
            ...
            <div class="row">
                ...
                (
                    ...
                    array('saxon-storage-open', 'saxon-storage-open-1.jpg', 'Saxon Storage - Open')
                );
                    // pickes two random product arrays from the $products array
