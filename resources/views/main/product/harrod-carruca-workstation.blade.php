...
@section('title', 'Harrod Carruca Workstation')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel image-slider o-flow-hidden">
                        <div class="item">
                            <img src="../img/products/dogbone-1.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/dogbone-2.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/dogbone-3.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/Carruca-Dogbone.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
