        ...
        <section class="pt pt-sm-80">
            <div class="container">
                ...
                <div class="row mb-60 mb-xs-30">
                    <div class="col-md-6">
                        <h4>The Executive Carruca Office Desk, L shape</h4>
                    </div>
                    <div class="col-md-6">
                        <p class="lead">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="owl-carousel image-slider o-flow-hidden">
                            ...
                            <div class="item">
                                <img src="../img/products/l-carruca-highpoint-new.jpg" alt="" />
                            </div>
                            <div class="item">
                                <img src="../img/products/l-carruca-show.jpg" alt="" />
                            </div>
                            <div class="item">
                                <img src="../img/products/l-carruca-show-closeup.jpg" alt="" />
                            </div>
                ...
                <div class="row mtb-60 mtb-xs-30">
                    <div class="col-md-4 mb-30">
                        <div class="project-detail-block">
                            <p>
                                <strong class="dark-color">Product :</strong>L-Shape Carruca Desk
                            </p>
                            <p>
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-30">
                                ...
                                <p>Desk: 30"W x 60"L & Return: 24"W x 30"L</p>
                                <p>Desk: 30"W x 72"L & Return: 24"W x 30"L</p>
                                <p>Desk: 36"W x 84"L & Return: 36"W x 30"L</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-30">
