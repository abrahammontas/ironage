...
@section('title', 'Carruca Workbench')
...
@section('content')
    ...
    <section class="inner-intro dark-bg bg-image overlay-dark parallax parallax-background1" data-background-img="../img/IAO/products-bg.jpg">
        <div class="container">
            <div class="row title">
                <h2 class="h2">The Hybrid Desk</h2>
            </div>
        </div>
    </section>
    <!-- End Intro Section -->
    ...
    <section class="pt pt-sm-80">
        <div class="container">
            <div class="row mb-60 mb-xs-30">
                <div class="col-md-6">
                    <h4>The Executive Hybrid Office Desk</h4>
                </div>
                <div class="col-md-6">
                    <p class="lead">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel image-slider o-flow-hidden">
                        <div class="item">
                            <img src="../img/products/long-island-rick-singer-1.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/long-island-rick.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/hybrid-desk-12x8.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mtb-60 mtb-xs-30">
                <div class="col-md-4 mb-30">
                    <div class="project-detail-block">
                        <p>
                            <strong class="dark-color">Product :</strong>Hybrid Desk
                        </p>
                        <p>
