    ...
    <section class="pt pt-sm-80">
        <div class="container">
            <div class="row mb-60 mb-xs-30">
                <div class="col-md-6">
                    <h4>EThe Tanto Office Desk/Dining Table</h4>
                </div>
                <div class="col-md-6">
                    <p class="lead">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel image-slider o-flow-hidden">
                        <div class="item">
                            <img src="../img/products/tanto-12x8.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/tanto-12x8-2.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mtb-60 mtb-xs-30">
                <div class="col-md-4 mb-30">
                    <div class="project-detail-block">
                        <p>
                            <strong class="dark-color">Product :</strong>Tanto
                        </p>
                        <p>
