...
@section('title', 'Torkel Coffee Table')
    ...
    <section class="pt pt-sm-80">
        <div class="container">
            <div class="row mb-60 mb-xs-30">
                <div class="col-md-6">
                    <h4>The Torkel Industrial Coffee Table</h4>
                </div>
                <div class="col-md-6">
                    <p class="lead">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel image-slider o-flow-hidden">
                        <!-- <div class="item">
                            <img src="../img/products/torkel-coffee-table-12x8.jpg" alt="" />
                        </div> -->
                        <div class="item">
                            <img src="../img/products/torkel-coffee-table-12x8-2.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/torkel-coffee-table-12x8-3.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mtb-60 mtb-xs-30">
                <div class="col-md-4 mb-30">
                    <div class="project-detail-block">
                        <p>
                            <strong class="dark-color">Product :</strong>Torkel Coffee Table
                        </p>
                        <p>
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-30">
                            ...
                            <p>48"L x 17"W x 17"H</p>
                            <p>60"L x 17"W x 17"H</p>
                            <p>60"L x 23"W x 17"H</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-30">
