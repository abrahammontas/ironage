...
@section('title', 'Rowan Console Table')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel image-slider o-flow-hidden">
                        <div class="item">
                            <img src="../img/products/rowan-console-table-12x8-3.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/rowan-console-table-12x8.jpg" alt="" />
                        </div>
                        <div class="item">
            ...
            <div class="row mtb-60 mtb-xs-30">
                <div class="col-md-4 mb-30">
                    <div class="project-detail-block">
                        <p>
                            <strong class="dark-color">Product :</strong>Rowan Console Table
                        </p>
                        <p>
