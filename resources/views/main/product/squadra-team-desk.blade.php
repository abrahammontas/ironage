...
@section('title', 'The Squadra Team Desk')
    ...
    <section class="pt pt-sm-80">
        <div class="container">
            <div class="row mb-60 mb-xs-30">
                <div class="col-md-6">
                    <h4>The Squadra Team Office Desk (with industrial lock casters)</h4>
                </div>
                <div class="col-md-6">
                    <p class="lead">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel image-slider o-flow-hidden">
                        <div class="item">
                            <img src="../img/products/squadra-desk-july.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/squadra-desk-july-2.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mtb-60 mtb-xs-30">
                <div class="col-md-4 mb-30">
                    <div class="project-detail-block">
                        <p>
                            <strong class="dark-color">Product :</strong>Sqaudra Team Desk
                        </p>
                        <p>
                            <strong class="dark-color">Drawers :</strong>Single or Double
                        </p>
                        <p>
                ...
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-30">
                            ...
                            <p>60"L x 30"W x 30"H</p>
                            <p>72"L x 30"W x 30"H</p>
                            <p>72"L x 36"W x 30"H</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-30">
                        ...
                        <div class="col-md-6 mb-30">
                            ...
                            <a href="../stains.php">View Stains Here</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2 text-center">
                    ...
                    <br />
                     <a class="btn btn-md btn-hover" style="background-color:#323232; color:white;" href="../contact-us.php">Inquire Now</a>
        ...
        <div class="container text-center">
            ...
            <div class="row">
                <?php
                    $products = array
                    (
                        array('l-shape-carruca', 'l-carruca-highpoint-new.jpg', 'L-Shape Carruca Desk'),
                        array('l-shape-brooklyn', 'l-brooklyn-office.jpg', 'L-Shape Brooklyn Desk'),
                        array('u-shape-carruca', 'u-shape-carruca-in-shop-12x8.jpg', 'U-Shape Carruca Desk'),
                        array('hybrid-desk', 'hybrid-desk-12x8.jpg', 'Hybrid Desk'),
                        array('tanto', 'tanto-12x8.jpg', 'Tanto Desk'),
                        array('standard-carruca', 's-carruca-12x8.jpg', 'Standard Carruca Desk')
                        // array('squadra-team-desk', 'squadra-desk-12x8.jpg', 'Squadra Team Desk')
                    );
