...
@section('title', 'Bastille Workstation')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="owl-carousel image-slider o-flow-hidden">
                        <div class="item">
                            <img src="../img/products/Bastille_1.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/Bastille_2.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/Bastille_3.jpg" alt="" />
                        </div>
                        <div class="item">
                            <img src="../img/products/workstation-1.jpg" alt="" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mtb-60 mtb-xs-30">
                <div class="col-md-4 mb-30">
                    <div class="project-detail-block">
                        <p>
                            <strong class="dark-color">Product :</strong>Bastille Workstation
                        </p>
                        <p>
    ...
    <section class="ptb ptb-40">
        <div class="container text-center">
            ...
            <div class="row">
                ...
                $products = array
                (
                        array('edwin-workstation', 'commercial-option-1-12x8.jpg', 'Edwin Workstation'),
